...
class User extends Authenticatable
{
    ...
    public function follow(){
        //return $this->belongsToMany("App\Models\Follow", "TABELLA follows", "SEGUACI followed_id", "SEGUITI follower_id");
    ...
    public function setPhotoAttribute($value){
        $path = $value ? Storage::disk("public")->put("photo", $value) : null;
